...
void ADC_Config()
{
	...
	ADC_CommonStruct.ADC_DMAAccessMode = ADC_DMAAccessMode_Disabled;  //TEKLİ ADC KANALI OKUDUĞUMUZ İÇİN BUNU SEÇİYORUZ
	...
	ADC_InitStruct.ADC_NbrOfConversion = 1;					//ÇEVRİM SAYISI
